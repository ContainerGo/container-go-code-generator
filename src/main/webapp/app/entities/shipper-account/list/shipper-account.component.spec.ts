...
import { sampleWithRequiredData } from '../shipper-account.test-samples';
import { ShipperAccountService } from '../service/shipper-account.service';

import { ShipperAccountComponent } from './shipper-account.component';
import SpyInstance = jest.SpyInstance;

describe('ShipperAccount Management Component', () => {
  let comp: ShipperAccountComponent;
  let fixture: ComponentFixture<ShipperAccountComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ShipperAccountComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(ShipperAccountComponent);
