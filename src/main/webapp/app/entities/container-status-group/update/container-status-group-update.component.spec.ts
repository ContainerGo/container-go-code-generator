...
describe('ContainerStatusGroup Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ContainerStatusGroupUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should update editForm', () => {
      const containerStatusGroup: IContainerStatusGroup = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      ...
      const containerStatusGroup = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
