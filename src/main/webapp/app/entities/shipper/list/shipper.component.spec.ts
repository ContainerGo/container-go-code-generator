...
import { sampleWithRequiredData } from '../shipper.test-samples';
...
describe('Shipper Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'shipper', component: ShipperComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.shippers?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to shipperService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getShipperIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getShipperIdentifier).toHaveBeenCalledWith(entity);
