...
import { EntityArrayResponseType, ShipperService } from '../service/shipper.service';
...
export class ShipperComponent implements OnInit {
  ...
  trackId = (_index: number, item: IShipper): number => this.shipperService.getShipperIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.shippers = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IShipper[] | null): IShipper[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.shipperService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
