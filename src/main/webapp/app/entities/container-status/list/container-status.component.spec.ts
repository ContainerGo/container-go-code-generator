...
import { sampleWithRequiredData } from '../container-status.test-samples';
...
describe('ContainerStatus Management Component', () => {
  let comp: ContainerStatusComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'container-status', component: ContainerStatusComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.containerStatuses?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to containerStatusService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getContainerStatusIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getContainerStatusIdentifier).toHaveBeenCalledWith(entity);
