...
import { EntityArrayResponseType, ContainerService } from '../service/container.service';
...
export class ContainerComponent implements OnInit {
  ...
  trackId = (_index: number, item: IContainer): number => this.containerService.getContainerIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.containers = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IContainer[] | null): IContainer[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.containerService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
