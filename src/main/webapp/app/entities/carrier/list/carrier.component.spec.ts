...
import { sampleWithRequiredData } from '../carrier.test-samples';
...
describe('Carrier Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'carrier', component: CarrierComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.carriers?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to carrierService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getCarrierIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCarrierIdentifier).toHaveBeenCalledWith(entity);
