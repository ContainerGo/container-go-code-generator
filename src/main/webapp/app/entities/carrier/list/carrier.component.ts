...
import { EntityArrayResponseType, CarrierService } from '../service/carrier.service';
import { CarrierDeleteDialogComponent } from '../delete/carrier-delete-dialog.component';
...
export class CarrierComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.carriers = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICarrier[] | null): ICarrier[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.carrierService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
