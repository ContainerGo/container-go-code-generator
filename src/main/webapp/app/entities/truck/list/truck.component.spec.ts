...
import { sampleWithRequiredData } from '../truck.test-samples';
...
describe('Truck Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'truck', component: TruckComponent }]), HttpClientTestingModule, TruckComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.trucks?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
