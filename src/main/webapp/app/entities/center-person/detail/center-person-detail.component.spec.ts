...
describe('CenterPerson Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CenterPersonDetailComponent],
      providers: [
        provideRouter(
          [
            {
              ...
              resolve: { centerPerson: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load centerPerson on init', async () => {
      ...
      // THEN
      expect(instance.centerPerson()).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
